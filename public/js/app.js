document.addEventListener('DOMContentLoaded', () => {
    ...
    pasteBtn.addEventListener('click', async () => {
        try {
            ...
            console.log("Clipboard API failed or blocked, falling back to prompt...");
        }

        // Fallback: prompt the user to paste their URL directly
        const pastedUrl = prompt("Paste your YouTube URL here:");
        if (pastedUrl) {
            youtubeUrlInput.value = pastedUrl.trim();
            showError(false);
        }
    });
